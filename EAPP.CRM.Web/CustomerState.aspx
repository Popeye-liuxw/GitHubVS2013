<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerState.aspx.cs"
    Inherits="EAPP.CRM.Web.CustomerState" MasterPageFile="~/MainTemplate.Master" %>
    ...
    <div id="content">
        ...
        <div id="right">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="gridview"
                Width="100%" DataKeyNames="StateId" OnRowCancelingEdit="GridView1_RowCancelingEdit"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <EditItemTemplate>
                            <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Update" CommandArgument='<%# Eval("StateId") %>'>更新</asp:LinkButton>
                            &nbsp;<asp:LinkButton ID="LinkButton4" runat="server" CommandName="Cancel">取消</asp:LinkButton>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Edit" CommandArgument='<%# Eval("StateId") %>'>编辑</asp:LinkButton>
                            &nbsp;<asp:LinkButton ID="LinkButton2" runat="server" CommandName="Delete" OnClientClick="return window.confirm('确定要删除');"
                                CommandArgument='<%# Eval("StateId") %>'>删除</asp:LinkButton>
                        </ItemTemplate>
                        <ItemStyle Width="97" />
                    </asp:TemplateField>
                </Columns>
