<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddFllowUpPlan.aspx.cs"
    Inherits="EAPP.CRM.Web.AddFllowUpPlan" MasterPageFile="~/MainTemplate.Master" %>

<%@ Register TagPrefix="uc1" Src="~/Control/Area.ascx" TagName="Area" %>
<asp:Content ContentPlaceHolderID="contentPlaceHolderMain" ID="content1" runat="server">
            ...
            <table border="0" style="width: 100%" class="inputTable">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" runat="server" id="txtContactTime" name="txtContactTime" readonly="readonly" />
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtContactTime"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="Interest" runat="server" TextMode="MultiLine" Columns="30" Rows="5"></asp:TextBox>
                    </td>
                    <th>
                        异议点:
                    </th>
                    <td>
                        <asp:TextBox ID="Dissent" runat="server" TextMode="MultiLine" Columns="30" Rows="5"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" runat="server" readonly="readonly" id="txtNextTime" name="txtNextTime" />
                    ...
                    <td>
                        <asp:TextBox ID="NextTiming" runat="server"></asp:TextBox>
                    </td>
                </tr>
            </table>
