<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="EAPP.CRM.Web.AddUser"
        ...
        <div id="right">
            ...
            <table style="border: 0px; width: 100%" class="inputTable">
                <tr>
                    ...
                    <td style="width: 40%">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtLoginName"
                            Display="Dynamic" ErrorMessage="登陆名必填项"></asp:RequiredFieldValidator>
                        <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="txtLoginName"
                            Display="Dynamic" ErrorMessage="登陆名已存在" ClientValidationFunction="ckLoginName"></asp:CustomValidator>
                    </td>
                    <th style="width: 10%">
                        角色:
                    </th>
                ...
                <tr>
                    ...
                    <td>
                        <%--<asp:CheckBox ID="ckIsAdmin" runat="server" />--%>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="txtAddress" runat="server" TextMode="MultiLine" Columns="80" Rows="2"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th>
                ...
                <tr>
                    ...
                    <td style="font-size: 14px; font-weight: bold; color: Red;" colspan="3">
                        新用户默认密码为:000000
                    </td>
                </tr>
            </table>
