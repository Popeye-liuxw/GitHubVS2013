<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerSource.aspx.cs"
    Inherits="EAPP.CRM.Web.CustomerSource" MasterPageFile="~/MainTemplate.Master" %>
    ...
    <div id="content">
        ...
        <div id="right">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="gridview"
                Width="100%" DataKeyNames="SourceId" OnRowCancelingEdit="GridView1_RowCancelingEdit"
                OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
                <Columns>
                    <asp:TemplateField HeaderText="客户来源">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Eval("Source") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Literal ID="Literal1" runat="server" Text='<%# Eval("Source") %>'></asp:Literal>
                        </ItemTemplate>
                        <ItemStyle Width="200" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <EditItemTemplate>
                            <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Update" CommandArgument='<%# Eval("SourceId") %>'>更新</asp:LinkButton>
                            &nbsp;<asp:LinkButton ID="LinkButton4" runat="server" CommandName="Cancel">取消</asp:LinkButton>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Edit" CommandArgument='<%# Eval("SourceId") %>'>编辑</asp:LinkButton>
                            &nbsp;<asp:LinkButton ID="LinkButton2" runat="server" CommandName="Delete" OnClientClick="return window.confirm('确定要删除');"
                                CommandArgument='<%# Eval("SourceId") %>'>删除</asp:LinkButton>
                        </ItemTemplate>
                        <ItemStyle Width="97" />
                    </asp:TemplateField>
                </Columns>
